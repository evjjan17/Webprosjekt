...
function ashe_scripts() {
	...
	// Theme Stylesheet
	wp_enqueue_style( 'ashe-style', get_stylesheet_uri(), array(), '1.5.3' );
	...
	wp_enqueue_style( 'ashe-responsive', get_theme_file_uri( '/assets/css/responsive.css' ), array(), '1.5.3'  );

	// Enqueue Custom Scripts
	wp_enqueue_script( 'ashe-plugins', get_theme_file_uri( '/assets/js/custom-plugins.js' ), array( 'jquery' ), '1.5.3', true );
	wp_enqueue_script( 'ashe-custom-scripts', get_theme_file_uri( '/assets/js/custom-scripts.js' ), array( 'jquery' ), '1.5.3', true );
